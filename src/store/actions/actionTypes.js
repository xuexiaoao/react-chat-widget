...
export const TOGGLE_VOICE = 'BEHAVIOR/TOGGLE_VOICE';
export const TOGGEL_VOICE_MODEL = 'BEHAVIOR/TOGGEL_VOICE_MODEL'
export const TOGGEL_MSG_USER_INPUT = 'BEHAVIOR/TOGGEL_MSG_USER_INPUT'
export const TOGGEL_CANCEL_VOICE = 'BEHAVIOR/TOGGEL_CANCEL_VOICE'
